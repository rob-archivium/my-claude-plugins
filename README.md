...
| **ripvec** | Semantic code search — find code by meaning, understand architecture through PageRank dependency graphs. GPU-accelerated on Metal (macOS) and CUDA (Linux). |
